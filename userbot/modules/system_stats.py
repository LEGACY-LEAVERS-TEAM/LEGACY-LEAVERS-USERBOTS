...
async def amireallyalive(alive):
    ...
    await alive.edit("__Connecting to server..__")
    await alive.edit("__Connecting to server...__")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡              🐈")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡             🐈")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡            🐈")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡           🐈")
    ...
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡🐈")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬-𝙐𝙎𝙀𝙍𝘽𝙊𝙏🐈")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬-𝙐𝙎𝙀𝙍𝘽𝙊🐈⚡")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬-𝙐𝙎𝙀𝙍𝘽🐈𝙏⚡")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬-𝙐𝙎𝙀𝙍🐈𝙊𝙏⚡")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬-𝙐𝙎𝙀🐈𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬-𝙐𝙎🐈𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬-𝙐𝗦🐈𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬-𝗨🐈𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬🐈𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖𝗬🐈-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗟𝗘𝗚𝗔𝗖🐈𝗬-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡𝗟𝗘𝗚𝗔🐈𝗖𝗬-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡🐈𝗔𝗖𝗬-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("🐈𝗟𝗘𝗚𝗔𝗖𝗬-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⚡")
    await alive.edit("⚡")
